...
import ModalDel from  "./EmployeeModalDel";
...
class Employee extends Component {
    ...
    handleSubmit = (item) => {
      ...
      if (item.employeeId) {
        ...
        axios
          //get from the address provided       
          .put(`/api/employee/${item.employeeId}/`, item)
          //refresh the list
    ...
    renderItems = () => {
      ...
      const newItems = this.state.empList;
    ...
    */
    render() {
      ...
      return (
        ...
        <h1 className="text-black text-uppercase text-center my-4">Employee Database</h1>
        <div className="row">
          ...
          <div className="col-md-12 col-sm-10 mx-auto p-0">
            <div className="card p-3">
              <div className="d-flex justify-content-between">
                ...
                <button onClick={this.createItem} className="btn btn-success mr-2">Add Employee</button>
                <button onClick={this.deleteItem} className="btn btn-danger mr-2">Delete Employee</button>
              </div>
              <div>
