...
import Modal from "./BranchModal";
import ModalDel from  "./BranchModalDel";
...
class Branch extends Component {
    ...
    handleSubmit = (item) => {
      ...
      if (item.branchId) {
        ...
        axios
          //get from the address provided       
          .put(`/api/branch/${item.branchId}/`, item)
          //refresh the list
    ...
    handleDelete = (item) => {
      ...
      axios
        ...
        .delete(`/api/branch/${item.branchId}/`)
        .then((res) => this.refreshList());
    };
    ...
    */
    render() {
      ...
      return (
        ...
        <h1 className="text-black text-uppercase text-center my-4">Branch Database</h1>
        <div className="row">
          ...
          <div className="col-md-12 col-sm-10 mx-auto p-0">
            <div className="card p-3">
              <div className="d-flex justify-content-between">
                ...
                <button onClick={this.deleteItem} className="btn btn-danger mr-2">Delete Branch</button>
              </div>
              <div>
